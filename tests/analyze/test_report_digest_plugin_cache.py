...
def test_parse_report_captures_plugin_cache_entries_and_merges():
    ...
    *_, plugin_cache, probe_summaries, harness_summaries = report_digest._parse_report(
        report
    )
...
def test_parse_report_uses_live_cache_for_legacy_reports(mocker):
    ...
    *_, plugin_cache, probe_summries, harness_summaries = report_digest._parse_report(
        report
    )
